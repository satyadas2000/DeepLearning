...
public class StockDataSetIterator implements DataSetIterator {
    ...
    /** stock dataset for test satya */
    public List<StockData> testdata;
    
    /** adjusted stock dataset for testing */
    private List<Pair<INDArray, INDArray>> test;

    public StockDataSetIterator (String filename, String symbol, int miniBatchSize, int exampleLength, PriceCategory category) {
