...
public class SparkLSTMClinicalTimeSeriesClassificationExample {
    private static File baseDir = new File("D:\\bigdata\\spark\\testdata\\physionet2012\\physionet2012\\");
   ...
   // public static final int NB_TEST_EXAMPLES = 4000 - NB_TRAIN_EXAMPLES - NB_VALID_EXAMPLES;
    ...
    public static final int NB_TRAIN_EXAMPLES = 500;
    ...
    public static final int lstmLayerSize = 30;    //Number of units in each GravesLSTM layer
