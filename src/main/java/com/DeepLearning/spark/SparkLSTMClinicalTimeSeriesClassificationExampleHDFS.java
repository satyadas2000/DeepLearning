package com.DeepLearning.spark;
...
//https://skymindacademy.blob.core.windows.net/physionet2012/physionet2012.tar.gz
//https://blog.cloudera.com/blog/2017/09/how-to-predict-icu-mortality-with-digital-health-data-dl4j-apache-spark-and-cloudera/
//https://github.com/deeplearning4j/dl4j-examples/blob/cdh_blog_july2017/dl4j-spark-cdh-examples/src/main/java/org/deeplearning4j/examples/SparkLSTMClinicalTimeSeriesClassificationExampleHDFS.java	
public class SparkLSTMClinicalTimeSeriesClassificationExampleHDFS {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // Path to sequence and mortality directories via HDFS - /resources/physionet2012/sequence
       String featuresPath = "file:///D://bigdata//spark//testdata//physionet2012//physionet2012//sequence";
       String labelsPath = "file:///D://bigdata//spark//testdata//physionet2012//physionet2012//mortality";
